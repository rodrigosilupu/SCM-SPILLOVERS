...
collapse (mean) rank_deaths rank_cases , by (country)
...
gen EC=observado[_n]-synthetic_control[_n]
gen EP=synthetic_control[_n]-synthetic_control[_n-1]
gen ES=alpha_hat-EC
gen EE=ET-alpha_hat-EP
gen ET2=EC+EP+ES+EE
gen provincia=`j'
drop if periodo==37
